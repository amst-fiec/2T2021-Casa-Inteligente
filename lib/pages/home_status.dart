  ...
  void getValues() async {
    ...
    if (qntyOfAlerts > 1) {
      ...
      if (qntyOfManyAlerts5Secs == 0) {
        _showMyDialog("Múltiples alertas", [
          Text(
            'Urgente: Revisar $qntyOfAlerts problemas',
        ...
        _showMyDialog("Alerta", [
          Text(
            "Han pasado $qntyOfManyAlerts5Secs minutos sin que se hayan resuelto todos los problemas",
            style: const TextStyle(color: Colors.white),
          ),
          Text(
            'Urgente: Revisar $qntyOfAlerts problemas',
                ...
                child: BounceInRight(
                  child: Row(
                    children: [
                      ...
                      Text(
                        'Bienvenido, ${FirebaseAuth.instance.currentUser!.displayName!.split(' ')[0]}',
    ...
    if (!manyAlerts && _connectionStatus != ConnectivityResult.none) {
      if (prioritie == 3) {
        if (qntyOf5Secs[index] == 0) {
          ...
          _showMyDialog("Alerta", [
            Text(
              "Han pasado ${qntyOf5Secs[index] * 5} minutos desde la primer alerta",
              style: const TextStyle(color: Colors.white),
            ),
            Text(
              text,
